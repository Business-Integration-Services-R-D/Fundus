...
MODEL_SAVE_PATH = 'resnet101_classifier.pth'
IMAGE_SIZE = (224, 224)
BATCH_SIZE = 32
LEARNING_RATE = 1e-4
NUM_EPOCHS = 70
...
COMET_EXPERIMENT_NAME = "DeepLabv3ResNet101"
    ...
    if COMET_API_KEY:
        try:
            ...
            hyper_params = {
                ...
                "image_size": IMAGE_SIZE[0], "model_architecture": "ResNet101_Backbone_Classifier",
                "optimizer": "Adam", "loss_function": "CrossEntropyLoss", "scheduler": "ReduceLROnPlateau",
